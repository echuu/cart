...
#
#
# left_rows = buildTree(z, all_rows)
# right_rows = setdiff(all_rows, left_rows)
# right_rows_level_1 = buildTree(z, right_rows)
# left_rows_level_1 = buildTree(z, left_rows)
# left_rows_level_2 = buildTree(z, left_rows_level_1)
#
# left = seq(1, n, 2) - 1
# right = seq(2, n, 2) - 1
# calculateRuleSSE(z, left, right)
#
#
#
#
